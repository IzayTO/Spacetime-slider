...
## V13 — escritorio / web
- Mantiene intacto el layout móvil y añade un layout específico para pantallas mayores de 760 px.
- Barra superior centrada, timeline de ancho controlado, menú circular de cuatro accesos y panel derecho tipo drawer.
- El panel de escritorio permanece cerrado hasta elegir Tiempo, Rebanadas, Gravedad o Recorte.
- El editor de recorte aprovecha más espacio en monitor sin cambiar la lógica móvil.
- Atajos de teclado en escritorio: Espacio = reproducir/pausar, R = centrar vista, M = menú, ←/→ = ±0.1 s, Shift+←/→ = ±1 s, Esc = cerrar panel/menú.
